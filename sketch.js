...
var engine, world;
var slingshot1, ground1, ground2, polygon, polygon_IMG;
var score, drag, canDrag, backgroundC;
...
function draw() {
    ...
    fill("red");
    textSize(20);
    text("You Need to drag the grumpy ball to hit the boxes." , 20,340);
